<template>
    <main class="app-social-proof-section">
        <div class="container">
            <div class="lg-header">
                <header>
                    <h1>{{heading}}</h1>
                ...
                <div class="star-ratings">
                    <rating v-for="rating in ratings" :key="rating" :rating="rating"></rating>
                </div>
            </div>
            <div class="reviews">
...
export default defineComponent({
  components: { Rating, Review },
    ...
    data(){
        const heading = "10,000+ of our users love our products.";
        const summary = "We only provide great products combined with excellent customer service. See what our satisfied customers are saying about our services.";
        const ratings: Array<any> = [
            { Title: "Rated 5 Stars in Reviews", Stars: 5 },
            { Title: "Rated 5 Stars in Report Guru", Stars: 5 },
            { Title: "Rated 5 Stars in BestTech", Stars: 5 }
        ];
        const reviews: Array<any> = [
            ...
            },
            {
                ...
                Review: " Customer services is always excellent and very quick turn around. Completely delighted with the simplicity of the purchase and the speed of delivery."
            },
            {
                Reviewer: {
                    Name: "Anne Wallace",
